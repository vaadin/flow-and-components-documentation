++++
<script shouldrun>
  const defineContentPreview = (is, additionalDefaultContent) => {
    customElements.define(is, class extends Polymer.Element {
  ...
  if (!customElements.get('content-preview')) {
    defineContentPreview('content-preview', Polymer.html`<style include="lumo-typography lumo-color lumo-badge">`);
    defineContentPreview('content-preview-md', Polymer.html`<style include="material-typography material-color">`);
  }

  if (!customElements.get('lumo-icon')) {
    customElements.define('lumo-icon', class extends Polymer.Element {
      static get template() {
        return Polymer.html`
          <style>
            :host {
    ...
    customElements.define('lumo-icons-viewer', class extends Polymer.Element {
      static get properties() {
        return {
          format: {
            type: String,
