...
[source, java]
----
include::../documentation/src/main/java/com/vaadin/flow/tutorial/theme/ImportingStyleSheets.java[tags=cssimport-id, indent=0, group=Java]
----

.`shared-typograhy.css`
[source, css]
----
include::../documentation/src/main/css/Theming.css[tags=shared-css, indent=0, group=Java]
----
...
[source, javascript]
----
include::../documentation/src/main/js/ImportStyleSheets.js[tags=import-css-function;export-css, indent=0, group=JavaScript]
----
--
...
[source, java]
----
include::../documentation/src/main/java/com/vaadin/flow/tutorial/theme/ImportingStyleSheets.java[tags=cssimport-include, indent=0, group=Java]
----
...
[source, javascript]
----
include::../documentation/src/main/js/ImportStyleSheets.js[tags=import-shared-css;import-css, indent=0, group=JavaScript]
----
--
...
[source, java]
----
include::../documentation/src/main/java/com/vaadin/flow/tutorial/theme/ImportingStyleSheets.java[tags=cssimport-themefor-include, indent=0, group=Java]
----

[source, javascript]
----
include::../documentation/src/main/js/ImportStyleSheets.js[tags=register-styles-include, indent=0, group=JavaScript]
----
--
...
[source, javascript]
----
include::../documentation/src/main/js/ImportStyleSheets.js[tags=import-polymer;import-shared-css;custom-element, indent=0, group=JavaScript]
----
