...
You should be familiar with <<style-scopes#,Style Scopes>>, <<css-custom-properties#,CSS Custom Properties>>, and <<importing-style-sheets#component-local-scope, Importing Style Sheets>> before you can style Vaadin components effectively.
...
----
[part="input-field"] {
  /* We use box-shadow for the border to avoid changing the
     dimensions of the element */
  /* We use the Lumo custom properties to make our changes
...
A subset of CSS selectors is considered as a part of a component’s public styling API.
...
The list of supported selectors includes:
...
+
ifdef::web[]
Read more about the standard https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors[CSS attribute selectors on MDN].
endif::web[]
+
