...
Write style sheets for Vaadin components and customize their internal theme implementation.


== Prerequisites

You should be familiar with <<style-scopes#,Style Scopes>> and how to include style sheets into component scopes (see <<importing-style-sheets#component-local-scope, Importing Style Sheets>>) before you can style Vaadin components effectively.
