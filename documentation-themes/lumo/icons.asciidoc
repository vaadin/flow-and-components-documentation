...
++++
    ...
    <p>Use the icon size custom properties to set consistent sizes for all icons across your application. The Lumo icons are drawn on a 24&times;24 pixel canvas – the <b>M size</b> fits that by default.</p>
