...
https://cdn.vaadin.com/vaadin-lumo-styles/1.5.0/demo/typography.html[Typography] and https://cdn.vaadin.com/vaadin-lumo-styles/1.5.0/demo/sizing-and-spacing.html[Sizing and Spacing] CSS properties.
ifdef::web[]
