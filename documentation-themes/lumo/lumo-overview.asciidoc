...
Lumo can be customized to fit your visual style requirements by adjusting the <<../css-custom-properties#,CSS Custom Properties>> it exposes as its public API.
