...
Include the color style sheet to apply basic colors for any style scope. It will set the background, text and link colors and enable you to use the dark palette colors inside that style scope.
...
The dark color palette is available when you include the main style sheet.
...
<!-- Include the "lumo-color" style sheet -->
<custom-style>
  <style include="lumo-color"></style>
</custom-style>
