...
[source,java]
----
include::../documentation/src/main/java/com/vaadin/flow/tutorial/theme/StylingApplications.java[tags=MyView, indent=0]
----

.`styles/my-view.css`
[source,css]
----
include::../documentation/src/main/css/StylingApplications.css[tags=my-view, indent=0]
----
...
[source, java]
----
include::../documentation/src/main/java/com/vaadin/flow/tutorial/theme/StylingApplications.java[tags=Image, indent=0, group=Java]
----
...
[source, javascript]
----
include::../documentation/src/main/js/StylingApplications.js[tags=image, indent=0, group=JavaScript]
----
...
[source, css]
----
include::../documentation/src/main/css/StylingApplications.css[tags=css-img, indent=0, group=CSS]
----
--
...
[source, java]
----
include::../documentation/src/main/java/com/vaadin/flow/tutorial/components/IconBasic.java[tags=VaadinIcons, indent=0, group=Java]
----
...
[source, javascript]
----
include::../documentation/src/main/js/StylingApplications.js[tags=vaadin-icons, indent=0, group=JavaScript]
----
--
...
[source, java]
----
include::../documentation/src/main/java/com/vaadin/flow/tutorial/components/IconBasic.java[tags=LumoIcon, indent=0, group=Java]
----

[source, javascript]
----
include::../documentation/src/main/js/StylingApplications.js[tags=lumo-icon, indent=0, group=JavaScript]
----
--
