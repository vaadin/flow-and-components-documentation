...
[source, html]
----
include::../documentation/src/main/html/ThemeVariants.html[tags=global-dark, indent=0, group=HTML]
----
--
...
They are defined in an additional stylesheet which you import (see <<importing-style-sheets#,Importing Style Sheets>>).
