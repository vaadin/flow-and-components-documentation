...
Light and dark modes are a good example of global variants.
...
In server-side views, use the `variant` attribute of the [classname]#@Theme# annotation.
See <<../using-themes#,Using Themes>> for more information.

[source, java]
----
include::../documentation/src/main/java/com/vaadin/flow/tutorial/theme/UsingComponentThemes.java[tags=lumo-dark, indent=0, group=Java]
----

In client-side views, set the `theme` attribute on the `document.documentElement` object.
...
In client-side templates, set the `theme` attribute on the `<html>` element.
...
[source, java]
----
include::../documentation/src/main/java/com/vaadin/flow/tutorial/theme/UsingComponentThemes.java[tags=themed-button, indent=0, group=Java]

include::../documentation/src/main/java/com/vaadin/flow/tutorial/theme/UsingComponentThemes.java[tags=themed-button2, indent=0, group=Java]

include::../documentation/src/main/java/com/vaadin/flow/tutorial/theme/UsingComponentThemes.java[tags=themed-button3, indent=0, group=Java]
----
...
[source, javascript]
----
include::../documentation/src/main/js/ThemeVariants.js[tags=themed-button, indent=0, group=JavaScript]
----
...
[source, html]
----
include::../documentation/src/main/html/ThemeVariants.html[tags=themed-button, indent=0, group=HTML]
----
--
...
They are defined in an additional stylesheet which you import.
...
[source, java]
----
include::../documentation/src/main/java/com/vaadin/flow/tutorial/theme/UsingComponentThemes.java[tags=combobox-variant, indent=0, group=Java]
----

In client-side view (JavaScript):

[source, javascript]
----
include::../documentation/src/main/js/ThemeVariants.js[tags=combobox-variant, indent=0, group=JavaScript]
----
...
[source, html]
----
include::../documentation/src/main/html/ThemeVariants.html[tags=combobox-variant, indent=0, group=HTML]
----
--
