...
The annotation has to be set to your <<../flow/routing/tutorial-routing-annotation#,root navigation>> level class or to the <<../flow/routing/tutorial-router-layout#,router layout>> component defined in its [classname]#@Route# annotation.
...
For Vaadin components, the built-in themes are located in the [filename]#theme# folder of each component package.
Import any additional theme style sheets, if you use some of the custom properties in that view.

[source, javascript]
----
include::../documentation/src/main/js/WaysOfImporting.js[tags=client-side-theme, indent=0, group=JavaScript]
----
--
