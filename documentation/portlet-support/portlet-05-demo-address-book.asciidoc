...
To get more familiar with setting up and maintaining a multi-module Vaadin Portlet project, take a look at the next chapter, <<portlet-06-creating-multi-module-portlet-project#,Creating Multi-Module Portlet Project>>.
