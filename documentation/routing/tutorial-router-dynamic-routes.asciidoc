...
To add new routes to a registry there is the RouteConfiguration helper class that
simplifies handling of new routes. To get a configuration for a specific scope there are
