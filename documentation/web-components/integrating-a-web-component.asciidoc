...
Web Components are a collection of web standards allowing you to create new HTML tags with custom name, reusability and full encapsulation on styles & markup. To understand more about what Web Components are, visit https://vaadin.com/docs/v11/flow/web-components/introduction-to-webcomponents.html[Introduction to Web Components].
