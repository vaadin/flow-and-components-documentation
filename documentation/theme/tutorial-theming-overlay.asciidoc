...
To style an overlay component it is necessary to create a style CSS module, target the stylable parts, instruct flow to import it
as a module targeting the specific component, and set the `theme` atribute to the main component in your view:
