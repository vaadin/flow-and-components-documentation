...
Do not add multiple `@Theme` annotations to your application, if you do, just the one at root level will be used.

.Sample setup to get Lumo themed components
[source,java]
----
@Route(value = "")
public class LumpApplication extends Div {
}
----
...
[source,java]
----
public class MyTheme extends AbstractTheme {
}
