...
The default theme for Vaadin apps. If you do not explicitly choose a theme, Lumo will be used. See the <<../../themes/lumo#,Lumo theme docs>> for all the details regarding it.
...
A theme inspired by the https://material.io[Material Design guidelines]. See the <<../../themes/material#,Material theme docs>> for all the details regarding it.
