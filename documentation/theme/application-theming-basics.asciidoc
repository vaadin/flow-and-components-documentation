...
For Polymer components, you can also include your styles directly in the HTML Polymer template file. This makes it easier to develop stand-alone, reusable and distributable components. See <<theming-crash-course#styling-polymer-components,Styling Polymer Components>> for more. 
