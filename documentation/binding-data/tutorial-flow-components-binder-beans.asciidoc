...
https://docs.jboss.org/hibernate/validator/5.4/reference/en-US/html_single/[There are] some number of predefined constraint annotations that mark a bound field as required using `HasValue.setRequiredIndicatorVisible`.
