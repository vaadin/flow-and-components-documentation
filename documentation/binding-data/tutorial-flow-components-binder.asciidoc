...
To bind a component to non-modifiable data, you can use a `null` value for the `setter`. 
...
To bind components that do not implement the `HasValue` interface to non-modifiable data, you can use the `ReadOnlyHasValue` helper class. 
