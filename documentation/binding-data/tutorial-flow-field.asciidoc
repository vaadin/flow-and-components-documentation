...
[NOTE]
Flow uses Polymer 3 (https://polymer-library.polymer-project.org/3.0/docs/about_30). This version provides the best compatibility for integrating third-party Web Components.
