...
As discussed in <<../../themes/importing-style-sheets#,Importing Style Sheets>> and <<tutorial-importing#,Importing HTML and JavaScript>>, you can import client-side dependencies or resource files using:
