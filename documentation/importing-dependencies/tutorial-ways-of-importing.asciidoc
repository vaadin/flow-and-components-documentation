...
= Ways of Importing Dependencies
...
// https://developer.mozilla.org/en-US/docs/Web/Web_Components/HTML_Imports suggests this is obsolete
...
// When is it best to use inline mode?
+
[NOTE]
