...
|devmode.transpile |
This flag can be used to enable ES5 transpilation in development mode for older browsers like Internet Explorer 11.
**Since Vaadin 14.2**, this flag is disabled by default.
