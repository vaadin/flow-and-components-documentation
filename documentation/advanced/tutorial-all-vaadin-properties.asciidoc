...
|devmode.transpile |
When set to `true`, enables ES5 transpilation in development mode for older browsers like Internet Explorer 11.
*This feature is available only in version 14.2 or newer of the Vaadin Platform 14 series. By default, this flag is disabled.*
