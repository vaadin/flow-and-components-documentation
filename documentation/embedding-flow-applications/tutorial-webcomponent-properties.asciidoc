...
<<tutorial-webcomponent-exporter#,7.1. _Embedding a Vaadin Application_>>.
...
configure the flags "bubbles", "cancelable", and "composed". See CustomEvent
(https://developer.mozilla.org/en-US/docs/Web/API/CustomEvent) for
