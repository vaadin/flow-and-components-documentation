...
This is described in <<configure-spring-authentication#,Configure Spring Authentication>> and <<configure-server-authentication#,Configure Servlet-Container>> articles.
