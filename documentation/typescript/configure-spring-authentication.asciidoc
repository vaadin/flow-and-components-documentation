...
In this article it is assumed that you have an already working Vaadin-15 project as it is described in the <<quick-start-guide-v15#, Start a new V15 project>> guide.
...
→ *Step 2* - Configure Spring `HttpSecurity` by enabling its built-ing form login.
