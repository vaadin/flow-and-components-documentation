...
If you see Java deprecation warnings during the build, check the <<starting-the-app#migrating-from-vaadin-10-14,Migration>> section in the *Client-side bootstrapping page*.
