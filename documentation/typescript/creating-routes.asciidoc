...
Vaadin Router allows to group related routes together under a common parent as a parent-children tree by using the `children` property during the configuration:
