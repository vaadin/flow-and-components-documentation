...
[NOTE]
If you are migrating from an earlier version of Vaadin, check the <<upgrading-from-vaadin14#migrating-from-vaadin-10-14,Migrating from Vaadin 10-14>> section below.
...
Before sending the bootstrap page response to the browser, the content can be modified as described in the <<application-shell#,Application Shell>> tutorial.
