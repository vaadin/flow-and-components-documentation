---
title: "Appendix: Service Methods Validation"
order: 150
layout: page
---

= Appendix: Service Methods Validation

Whenever a Vaadin service method is invoked, its parameters  are automatically validated
...
Vaadin validates only the beans and method parameters that are used in the service classes
