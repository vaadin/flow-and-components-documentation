...
[NOTE]
Please note that at the moment an additional Servlet is required to handle
the `frontend resources` for non-root context, when using `vaadin.urlMapping`,
<<../../tutorial-servlet-spring-boot/src/main/java/org/vaadin/diego/spring/Application.java#,
see how to do it>>.
