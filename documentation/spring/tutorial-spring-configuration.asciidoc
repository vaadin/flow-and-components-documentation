...
The servlet can be defined in your application class, link:../.
./tutorial-servlet-spring-boot/src/main/java/org/vaadin/tutorial/spring/Application.java[see here for an example].
