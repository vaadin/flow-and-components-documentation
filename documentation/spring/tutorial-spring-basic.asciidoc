...
The Vaadin Spring (https://vaadin.com/directory/component/vaadin-spring) add-on allows you to use Vaadin Flow with Spring Boot (https://spring.io/projects/spring-boot). 

Spring Boot (https://spring.io/projects/spring-boot) speeds up the development process and provides a fast and efficient development environment by emphasising . It is the easiest way to use the Spring framework. 

[NOTE]
See <<tutorial-spring-basic-mvc#,9.2. _Use Flow with Spring MVC_>> to learn how to use Vaadin in more traditional Spring MVC (https://docs.spring.io/spring/docs/current/spring-framework-reference/web.html) web application, without Spring Boot. 
...
[TIP]
Follow the instructions on Spring Boot documentation (https://docs.spring.io/spring-boot/docs/current/reference/html/howto-traditional-deployment.html), if you want to deploy your Spring Boot application as a traditional WAR file.

== Vaadin Spring Boot examples

Vaadin Spring Examples (https://github.com/vaadin/flow-spring-examples) is an example application that showcases basic usage of Vaadin and Spring Boot. You can use it to test the concepts and features covered in this documentation.
