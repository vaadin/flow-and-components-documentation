...
With Vaadin views are defined as Java classes using `@Route` annotation. Component scan will detect the classes and publish them in a path derived from the class name or defined as parameter to the annotation. 
