...
Routing works the same way with Spring as it does in standard Vaadin Flow applications. See <<../routing/tutorial-routing-annotation#,Routing and Navigation>> for more. 

This content applies to using Vaadin Flow with both <<tutorial-spring-basic#,Spring Boot>> and <<tutorial-spring-basic-mvc#,Spring MVC>>.
...
You can also define all other possible routes in the same way as in standard Vaadin Flow applications. See  
