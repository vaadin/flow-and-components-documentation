...
The column's key will be "address.postalCode" and its header will be "Postal Code". Note that this does not work unless you're using the Grid constructor that takes the bean type.
