...
==== Setting Automatic Columns Sortable

When using columns defined by property names, you can set them as sortable in a single step, by using the `setColumnsSortable` method. For example, instead of using this:
