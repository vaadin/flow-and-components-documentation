...
The Vaadin platform includes a set of components (https://vaadin.com/components/browse), with server-side Java APIs, that you can use to build your UI.

The components, together with Flow, are included as platform dependencies.

TIP: Watch the Vaadin 10+: Intro (https://vaadin.com/training/course/view/v10-intro) free training video to learn more about the Vaadin platform terminology and what Vaadin components are.
...
The platform also includes theming for the components that you can edit to ensure the styling suits your UI. See <<../theme/using-component-themes#,8.5. _Using Component Themes_>> for more.

You can find additional prebuilt Web Components (with Java APIs) contributed by the Vaadin community in the Vaadin Directory (https://vaadin.com/directory).
