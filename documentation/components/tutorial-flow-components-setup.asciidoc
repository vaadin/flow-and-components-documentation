...
The Vaadin Platform includes a set of prebuilt server-side https://vaadin.com/components/browse[components], with Java APIs, that you can use to build your UI.   
