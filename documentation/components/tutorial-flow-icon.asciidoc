...
`Icon` is for displaying an icon from https://vaadin.com/directory/component/vaadinvaadin-icons[vaadin-icons]
...
icons from https://vaadin.com/directory/component/vaadinvaadin-icons[vaadin-icons], e.g.
