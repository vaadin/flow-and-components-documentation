...
** In conjunction, the lines `setHeight("100vh")` and `grid.setSizeFull()` make sure that both the app and the `Grid` use the entire available vertical space. "100vh" means 100% of the viewport height and is more reliable then setting your main view to "100%". 
