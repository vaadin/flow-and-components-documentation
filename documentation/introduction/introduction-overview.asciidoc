...
TIP: Watch the https://vaadin.com/training/course/view/v10-intro[Vaadin 10+: Intro] free training video to learn more about the Vaadin platform, basic Vaadin application architecture and how Vaadin components work.
