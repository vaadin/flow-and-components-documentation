...
You can use these components in the same way as any other component in your Java environment. Flow does not distinguish between pure Java or HTML/Java combined components.
...
Flow provides the `Router` class to structure the navigation of your web app or site into logical parts.
