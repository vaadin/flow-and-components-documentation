...
Vaadin consists of a large set of premade UI components and widgets that you can combine and extend in any way you like.
...
The same features are available regardless of the language you use.

All components are pre-tested and work in all modern browsers.
This allows you to spend your development time on your application, not testing with umpteen different browsers and operating systems.
When you do want to create tests, Vaadin has got you covered with purpose-built tools.
