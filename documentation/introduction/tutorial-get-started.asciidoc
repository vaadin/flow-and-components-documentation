...
[NOTE]
A theme called Lumo will be applied to the application by default, providing nice look and feel.
If we would use another theme, we would define it with `@Theme` annotation on top of our `MainView`.
