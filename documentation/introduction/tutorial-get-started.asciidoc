...
To finish off the setter method, let's add setCustomer(null) to the end of the constructor to make sure that the save and delete buttons are disabled by default.
