...
* The value of the `items` attribute declares which items to loop. The `item` property is set on the binding scope of each instance, resulting in sub-property bindings.
