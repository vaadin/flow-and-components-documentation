...
*Example*: `<slot>` element in `component-container.js` Polymer template.
...
*Example*: `component-container.js` Polymer template that shows the actual view, `MainLayout`, below a heading and a menu.
[source,js]
----
import {PolymerElement, html} from '@polymer/polymer/polymer-element.js';
