...
profile named productionMode is added to pom.xml of ui module. Production mode
in V10 is not the same as V8 and new production mode of V10 is fully described
