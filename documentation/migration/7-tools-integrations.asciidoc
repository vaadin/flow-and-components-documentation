...
Vaadin 8 has a CDI Add-on enabling JEE features.

CDI support is now also available for Vaadin platform. For more details please visit https://github.com/vaadin/cdi[Vaadin CDI GitHub repository].
