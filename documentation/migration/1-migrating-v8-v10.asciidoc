...
Switching from Vaadin 8 to Vaadin 10 could be considered as switching from a modern car to a flying car - the use cases are the same,
...
In addition, migration from V8 to V10 is illustrated in a simple example
