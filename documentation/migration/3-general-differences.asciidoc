...
In Vaadin 10 to 18, the default loading indicator is the same as in Vaadin 8 Valo Theme.

Starting from Vaadin 19, the connection indicator replaces the loading indicator. The new connection indicator remains compatible with the old loading indicator styles. If you want to customize it or disable it, you should see
the <<../advanced/tutorial-connection-indicator#,connection indicator documentation>>.
