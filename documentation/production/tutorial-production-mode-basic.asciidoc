...
The main difference between the development and production modes is that in development mode Vaadin uses Webpack to serve JavaScript files to the browser, instead of the Java server the app is running on. 
