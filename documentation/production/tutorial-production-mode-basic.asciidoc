...
With this the server can be started with `mvn jetty:run-exploded -Pproduction`.
...
Bundling can also be made to create multiple bundle chunks. For information on this see <<tutorial-production-mode-customising#,Customizing Bundling>>
