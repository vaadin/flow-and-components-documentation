...
* Create a https://vaadin.com/start/latest[Vaadin Starter] project
* Download an https://vaadin.com/start/latest[example application], which you can then modify to your purposes.
* Create and theming a project at https://start.vaadin.com/[start.vaadin.com]
* Create a project from a Maven archetype.
* In the Eclipse IDE, create a project with the Vaadin Plugin.
