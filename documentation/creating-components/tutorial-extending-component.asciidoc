...
You can extend a components either using server-side or client-side approaches. In this chapter we'll present two different approaches to do the same modification for the built-in text field component.

== Extending a component using server-side approach
