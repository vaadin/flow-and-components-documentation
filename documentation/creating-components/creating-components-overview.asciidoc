...
[NOTE]
You can also create components using HTML with Lit templates. See <<../templates/tutorial-template-basic#,Creating a Simple Component Using the Template API>> for more.
