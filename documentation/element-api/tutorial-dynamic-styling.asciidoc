...
* Using  `getClassList()` limits you to styles that have been defined in advance. 
...
* You can use the `getStyle()` method to style any property supported by the browser.
