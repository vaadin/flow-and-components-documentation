...
* Powerful abstraction layers to bulid your own reusable UI components with either Java or HTML templates.
...
* <<advanced/tutorial-sswc#,Embedding a Flow Application>>
