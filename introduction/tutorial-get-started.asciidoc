...
== Starting a Project with the Skeleton Starter
...
Skeleton Starter Flow. Skeleton Starters are project stubs that have dependencies set
...
. Select the Skeleton Starter Flow by clicking it
...
sufficient. In the Skeleton Starter there is an example of servlet definition,
...
templates inside a [filename]#src# and split it further into components, views etc.
