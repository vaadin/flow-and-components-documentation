...
== Starting a Project with the Project Base
...
Project Base for Flow. Project Bases are project stubs that have dependencies set
...
. Select the Project Base by clicking it
...
sufficient. In the Project Base there is an example of servlet definition,
