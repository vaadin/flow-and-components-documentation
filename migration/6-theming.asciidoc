...
Themes define the look and feel for the Vaadin components. The themes have been the base for the application specific theme.
...
and feel for your application you had before. The DOM is, however, different for the new components,
