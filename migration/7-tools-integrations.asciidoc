...
There are no archetypes available for Vaadin 10. Please visit [vaadin.com/start](https://vaadin.com/start) for available starting points.
...
you should voice your concern in our [Forum](https://vaadin.com/forum) or [github](https://github.com/vaadin/flow).
