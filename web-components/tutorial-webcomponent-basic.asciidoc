...
[NOTE]
If you are using some project base or a demo such as https://github.com/vaadin/beverage-starter-flow[`Beverage Buddy`] as a starting point, you probably have everything already configured. In this case, you can skip to <<Installing the Web Component>>.
